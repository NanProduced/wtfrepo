...
/** Handles M04 {@code SpecimenTagsChangedEvent} for pair incremental rebuild. */
@Component
public class SpecimenTagsChangedOutboxEventHandler implements OutboxStreamEventHandler {

  private static final Logger log = LoggerFactory.getLogger(SpecimenTagsChangedOutboxEventHandler.class);

  private static final String EVENT_TYPE = "SpecimenTagsChangedEvent";

  private final ArenaOutboxPayloadReader payloadReader;
  private final ArenaSpecimenMatchPairRebuildService rebuildService;

  public SpecimenTagsChangedOutboxEventHandler(
